...
export function UserSelection({ users, onSelectUser, getUserTaskCount }: UserSelectionProps) {
  return (
          ...
          {users.map((user) => {
            ...
            return (
              <div key={user.id}>
                    ...
                    <div className="flex-1">
                      ...
                      {total > 0 ? (
                        ...
                        <p className="text-sm text-muted-foreground">
                          {isShared 
                            ? 'No shared goals yet - create our tasks!' 
                ...
                {/* Show Family Task Demo only for shared profile with no tasks */}
                {isShared && total === 0 && (
                  <div className="mt-3">
                    <FamilyTaskDemo />
                  </div>
